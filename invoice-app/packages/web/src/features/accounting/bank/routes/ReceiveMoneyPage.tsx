...
export function ReceiveMoneyPage() {
  ...
  return (
    ...
    >
      <div className="max-w-2xl" data-testid="receive-money-page">
        {step === 1 && (
          <div data-testid="receive-step-1">
            <h2 className="mb-4 text-lg font-semibold text-gray-900">
              Select Bank Account
            </h2>
            <p className="mb-4 text-sm text-gray-500">
              Choose which bank account this payment will go into.
            </p>
            ...
            <div className="mt-6 flex gap-2">
              <Link to="/bank">
                <Button variant="outline" data-testid="receive-cancel-btn">
                  Cancel
                </Button>
              </Link>
              <Button
        ...
        {step === 2 && (
          <div data-testid="receive-step-2">
            <MoneyForm
              type="receive"
              accounts={accounts}
